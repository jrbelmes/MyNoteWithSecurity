  ...
  const fetchAdminData = async () => {
    try {
      ...
      if (result.status === 'success' && result.data.length > 0) {
        ...
        setPersonalInfo({
          firstName: userData.dept_fname,
          middleName: userData.dept_mname,
          lastName: userData.dept_lname,
          schoolId: userData.dept_school_id,
          email: userData.dept_email,
          phoneNumber: userData.dept_contact_number || '',
