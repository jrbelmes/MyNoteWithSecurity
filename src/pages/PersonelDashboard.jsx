...
const Dashboard = () => {
    ...
    const [releaseStatus, setReleaseStatus] = useState(null); // Add this state
    ...
    const handleRelease = useCallback(async (reservationId) => {
        try {
            const personel = localStorage.getItem('user_id');
            if (!personel) {
                ...
                <div className="h-full flex flex-col">
                    ...
                    <header className="bg-white shadow-md p-4">
                        <div className="flex justify-between items-center">
                            <h1 className="text-2xl font-bold text-green-800">Personnel Dashboard</h1>
                            ...
                            <div className="mt-8 flex justify-end space-x-4">
                                {selectedReservation.reservation?.reservation_status_name === 'reserve' && (
                                    <button 
                                        ...
                                        disabled={loading || releaseStatus}
                                    >
